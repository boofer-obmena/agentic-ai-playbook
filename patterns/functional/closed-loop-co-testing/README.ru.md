...
**Связь с другими паттернами:** Паттерн 033 (Семантический веер запросов) — коммуникатор применяет веерную технику формирования запросов. Паттерн 20 (Ratchet Loop) — результаты тестирования становятся основой для улучшения как промптов коммуникатора, так и наполнения базы знаний.
