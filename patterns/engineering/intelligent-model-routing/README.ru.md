---
id: PATTERN-036
title: "Паттерн И7. «Интеллектуальная маршрутизация с самооценкой сложности» (Intelligent Model Routing)"
type: pattern
subtype: engineering
status: raw
